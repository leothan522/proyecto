...
@section('content')
    ...
    <div class="row justify-content-center p-1">
        ...
        <div class="col-12 col-sm-6 col-md-12">
            <div class="info-box mb-3">
                <span class="info-box-icon bg-lightblue elevation-1"><i class="fa fa-cubes"></i></span>
                <div class="info-box-content">
                    ...
                    <ul class="nav nav-pills flex-column">
                        ...
                        <li class="nav-item active">
                            <a href="#" class="nav-link" data-toggle="modal" data-target="#modal-{{ $feria->id }}">
                                <span CLASS="text-sm">{{ $i }}.- {{ mesEspanol(intval($feria->months)) }}</span>
                                <span class="float-right justify-content-center row col-5">
                                    <span class="badge bg-danger col-5">{{ formatoMillares($feria->familias, 0) }}</span>
