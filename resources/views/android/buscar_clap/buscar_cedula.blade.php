        ...
        <div class="col-12">
            <div class="card card-navy">
                <div class="card-header">
                    <h3 class="card-title col-10">Listado de Cédulas <span class="float-right text-bold">{{ formatoMillares($resultados->count() + $censo->count(), 0) }}</span></h3>
                ...
                <div class="card-body p-0" style="display: block;">
                    <ul class="nav nav-pills flex-column">
                        ...
                        @foreach ($censo as $clap)
                                @php($i++)
                                <li class="nav-item active">
                                    <a href="#" class="nav-link" data-toggle="modal" data-target="#modal-{{ $clap->id }}">
                                        <span class="text-xs">{{ $i }}.-</span> <span class="text-bold">{{ formatoMillares($clap->cedula, 0) }}</span>
                                        <span class="float-right text-sm">
                                         {{ $clap->nombre_completo }}
                                    </span>
                                    </a>
                                </li>
                                <!-- Modal -->
                                <div class="modal fade" id="modal-{{ $clap->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-xl" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">CLAP <span class="text-bold">{{ $clap->claps->nombre_clap }}</span></h5>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                </button>
                                            </div>
                                            <div class="modal-body">
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <span class="form-control">{{ formatoMillares($clap->cedula, 0) }}</span>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label for="name">Nombre del Responsable</label>
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <span class="form-control text-sm">
                                                            {{ strtoupper($clap->nombre_completo) }}
                                                        </span>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <span class="form-control">{{ strtoupper($clap->telefono_1) }}</span>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <label for="name">Email</label>
                                                                    ...
                                                                    @if($clap->programa == "BMS")
                                                                        <div class="col-md-2">
                                                                            ...
                                                                            <div class="input-group mb-3">
                                                                                ...
                                                                                <span class="form-control">{{ $clap->claps->programa }}</span>
                                                                            </div>
                                                                        </div>
                                                                    @endif
                                                                    @if($clap->claps->programa == "CLAP")
                                                                        <div class="col-md-2">
                                                                            <label for="name">Bloque</label>
                                                                            <div class="input-group mb-3">
                                                                                <div class="input-group-prepend">
                                                                                ...
                                                                                <span class="form-control">{{ $clap->claps->parametros->valor }}</span>
                                                                            </div>
                                                                        </div>
                                                                    @endif
                                                                    <div class="col-md-2">
                                                                        ...
                                                                        <div class="input-group mb-3">
                                                                            ...
                                                                            <span class="form-control">{{ formatoMillares($clap->claps->num_familias, 0) }}</span>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-2">
                                                                        <label for="name">Nº Lideres de Calle</label>
                                                                        <div class="input-group mb-3">
                                                                            ...
                                                                            <span class="form-control">{{ formatoMillares($clap->claps->num_lideres, 0) }}</span>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-2">
                                                                        <label for="name">Última Atención</label>
                                                ...
                                                @if($clap->claps->productivo == "SI" || $clap->claps->productivo == "Si")
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="card card-navy collapsed-card">
                                                                <div class="card-header">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                                                            ...
                                                                            <div class="input-group mb-3">
                                                                                ...
                                                                                <span class="form-control">{{ strtoupper($clap->claps->productivo) }}</span>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-6">
                                                                            <label for="name">Tipo de Producción</label>
                                                                            <div class="input-group mb-3">
                                                                                ...
                                                                                <span class="form-control">{{ strtoupper($clap->claps->tipo_produccion) }}</span>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-md-12">
                                                                            <label for="name">Detalles de Producción</label>
                                                                            <div class="input-group mb-3">
                                                                                <p class="form-control">{{ strtoupper(trim($clap->claps->detalles_produccion)) }}</p>
                                                                            </div>
                                                                        </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-4">
                                                                        ...
                                                                        <div class="input-group mb-3">
                                                                            ...
                                                                            <span class="form-control">{{ strtoupper($clap->claps->longitud) }}</span>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <label for="name">Latitud</label>
                                                                        <div class="input-group mb-3">
                                                                            ...
                                                                            <span class="form-control">{{ strtoupper($clap->claps->latitud) }}</span>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <label for="name">Google Maps</label>
                                                                        <div class="input-group mb-3">
                                                                            ...
                                                                            <span class="form-control">{{ strtoupper($clap->claps->google_maps) }}</span>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-12">
                                                                        <label for="name">Dirección</label>
                                                                        <div class="input-group mb-3">
                                                                            <p class="form-control">{{ strtoupper(trim($clap->claps->direccion)) }}</p>
                                                                        </div>
                                                                    </div>
