                            ...
                            <li class="nav-item active">
                                <a href="{{ route('android.ferias_campo_parroquia', [Auth::user()->id, $municipio->id, $parroquia->id]) }}" class="nav-link" onclick="verCargando()">
                                    ...
                                    <span class="float-right justify-content-center row col-8">
                                        <span class="badge bg-orange col-3">{{ formatoMillares($parroquia->ferias, 0) }}</span>
                                        <span class="col-1"></span>
										<span class="badge bg-maroon col-3">{{ formatoMillares($parroquia->familias, 0) }}</span>
                                        <span class="col-1"></span>
                                        <span class="badge bg-indigo col-3">{{ formatoMillares($parroquia->tm, 2) }}</span>
                                    </span>
                                    </span>
                                </a>
                            </li>
