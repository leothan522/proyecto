    ...
    <div class="container-fluid">
        ...
        <div class="row justify-content-center">
                            ...
                            <div class="btn-group show">
                                ...
                                <div class="dropdown-menu" role="menu" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(-52px, 31px, 0px);">
                                    @foreach($filtrar as $municipio)
                                        <a href="{{ route('proteico.show', $municipio->id) }}" class="dropdown-item">{{ $municipio->nombre_completo }}</a>
                                    @endforeach
                                        <div class="dropdown-divider"></div>
                                    <a href="{{ route('proteico.index') }}" class="dropdown-item">Ver Todo</a>
                                </div>
                            </div>
                                ...
                                @foreach ($ferias as $feria)
                                    <tr>
                                        ...
                                        <td class="">
                                            ...
                                            <div class="btn-group">
                                                @if (leerJson(Auth::user()->permisos, 'proteico.edit') || Auth::user()->role == 100)
                                                    <a href="{{ route('proteico.edit', $feria->parroquias_id) }}" class="btn btn-info"><i class="fas fa-list"></i></a>
                                                @endif
            ...
            <div class="col-md-3">
                <div class="card card-primary card-outline">
                    <div class="card-header">
                        <h5 class="card-title">Procedencias</h5>
                        <div class="card-tools">
                            @if (leerJson(Auth::user()->permisos, 'proteico.show') || Auth::user()->role == 100)
                                <button type="button" class="btn btn-tool" data-toggle="modal" data-target="#modal-procedencia-create">
                                    <i class="fas fa-plus-square"></i>
                                </button>
                                <!-- Modal -->
                                <div class="modal fade" id="modal-procedencia-create" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">Agregar Procedencia</h5>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                </button>
                                            </div>
                                            <div class="modal-body">
                                                ...
                                                {!! Form::open(['route' => 'proteico.store', 'method' => 'POST']) !!}
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        ...
                                                        {!! Form::text('valor', null, ['class' => 'form-control', 'placeholder' => 'Nombre', 'required']) !!}
                                                    </div>
                                                </div>
                                                <div class="form-group text-right">
                                                    <input type="hidden" name="nombre" value="proteico_procedencia">
                                                    <input type="submit" class="btn btn-block btn-primary" value="Guardar">
                                                </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover bg-light">
                                ...
                                @foreach ($procedencias as $procedencia)
                                    <tr>
                                        <td>{{ $procedencia->valor }}</td>
                                        <td class="">
                                            {!! Form::open(['route' => ['proteico.parametro', $procedencia->id], 'method' => 'DELETE', 'id' => 'form_proteico_'.$procedencia->id]) !!}
                                            <div class="btn-group">
                                                @if (leerJson(Auth::user()->permisos, 'proteico.update') || Auth::user()->role == 100)
                                                    <button type="button" class="btn btn-info" data-toggle="modal" data-target="#modal-{{ $procedencia->id }}">
                                                        <i class="fas fa-edit"></i>
                                                    </button>
                                                @endif
                                                @if (leerJson(Auth::user()->permisos, 'proteico.parametro') || Auth::user()->role == 100)
                                                    <button type="button" onclick="alertaBorrar('form_proteico_{{ $procedencia->id }}')" class="btn btn-info show-alert-{{ $procedencia->id }}"><i class="fas fa-trash"></i></button>
                                                @endif
                                            </div>
                                        {!! Form::close() !!}

                                        <!-- Modal -->
                                            <div class="modal fade" id="modal-{{ $procedencia->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="exampleModalLabel">Modificar Procedencia</h5>
                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                <span aria-hidden="true">&times;</span>
                                                            </button>
                                                        </div>
                                                        <div class="modal-body">
                                                            ...
                                                            {!! Form::open(['route' => ['proteico.update', $procedencia->id], 'method' => 'PUT']) !!}
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group mb-3">
                                                                    ...
                                                                    {!! Form::text('valor', $procedencia->valor, ['class' => 'form-control', 'placeholder' => 'Nombre', 'required']) !!}
                                                                </div>
                                                            </div>
                                                            <div class="form-group text-right">
                                                                <input type="hidden" name="nombre" value="proteico_procedencia">
                ...
                <div class="card card-primary card-outline">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            @if (leerJson(Auth::user()->permisos, 'proteico.show') || Auth::user()->role == 100)
                                <button type="button" class="btn btn-tool" data-toggle="modal" data-target="#modal-rubros-create">
                                    <i class="fas fa-plus-square"></i>
                                </button>
                                <!-- Modal -->
                                <div class="modal fade" id="modal-rubros-create" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group text-right">
                                                    <input type="hidden" name="nombre" value="proteico_rubro">
                                                    <input type="submit" class="btn btn-block btn-primary" value="Guardar">
                                                </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover bg-light">
                                <thead class="thead-dark">
                                <tr>
                                    <th scope="col" data-breakpoints="xs">ID</th>
                                    <th scope="col">Nombres</th>
                                    <th scope="col" data-breakpoints="xs" style="width: 10%;"></th>
                                </tr>
                                </thead>
                                ...
                                @foreach ($rubros as $rubro)
                                    <tr>
                                        ...
                                        <td>{{ $rubro->valor }}</td>
                                        <td class="">
                                            {!! Form::open(['route' => ['proteico.parametro', $rubro->id], 'method' => 'DELETE', 'id' => 'form_proteico_'.$rubro->id]) !!}
                                            <div class="btn-group">
                                                @if (leerJson(Auth::user()->permisos, 'proteico.update') || Auth::user()->role == 100)
                                                    <button type="button" class="btn btn-info" data-toggle="modal" data-target="#modal-{{ $rubro->id }}">
                                                        <i class="fas fa-edit"></i>
                                                    </button>
                                                @endif
                                                @if (leerJson(Auth::user()->permisos, 'proteico.parametro') || Auth::user()->role == 100)
                                                    <button type="button" onclick="alertaBorrar('form_proteico_{{ $rubro->id }}')" class="btn btn-info show-alert-{{ $rubro->id }}"><i class="fas fa-trash"></i></button>
                                                @endif
                                            </div>
                                        {!! Form::close() !!}

                                        <!-- Modal -->
                                            <div class="modal fade" id="modal-{{ $rubro->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="exampleModalLabel">Modificar Procedencia</h5>
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            {!! Form::open(['route' => ['proteico.update', $rubro->id], 'method' => 'PUT']) !!}
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group mb-3">
                                                                    ...
                                                                    {!! Form::text('valor', $rubro->valor, ['class' => 'form-control', 'placeholder' => 'Nombre', 'required']) !!}
                                                                </div>
                                                            </div>
                                                            <div class="form-group text-right">
                                                                <input type="hidden" name="nombre" value="proteico_rubro">
