        ...
        switch ($request->mod) {
            ...
            case "permisos":
                ...
                $permisos = [
                    ...
                    'ferias.edit'    => $request->input('ferias_campo'),
                    ...
                    'movil.edit'    => $request->input('tienda_movil'),
                    ...
                    'fisica.index'    => $request->input('tienda_fisica'),
                    'fisica.edit'    => $request->input('tienda_fisica'),
                    'fisica.store'    => $request->input('tienda_fisica'),
                    'fisica.show'    => $request->input('tienda_fisica'),
                    ...
                    'enlinea.edit'    => $request->input('tienda_enlinea'),
                    ...
                    'proteico.edit'    => $request->input('plan_proteico'),
