...
class ClapsImport implements ToModel, WithHeadingRow
{
    ...
    public function model(array $row)
    {
        ...
        if ($municipio && $parroquia) {
            ...
            $observaciones = [];
            if ($municipio){ $observaciones['municipio'] = null; }else{ $observaciones['municipio'] = "true"; }
            if ($parroquia){ $observaciones['parroquia'] = null; }else{ $observaciones['parroquia'] = "true"; }
